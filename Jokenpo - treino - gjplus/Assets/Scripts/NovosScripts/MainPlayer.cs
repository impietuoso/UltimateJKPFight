...
public class MainPlayer : MonoBehaviour {
    ...
    private void Start() {
        ...
        MultiplayerCombat.instance.player1 = this.gameObject;
        if (pv.IsMine) {
            MultiplayerCombat.instance.actions1.SetActive(true);
            pv.RPC("PassMainPlayerInfo1", RpcTarget.All, PlayerPrefs.GetString("playerName"));
        }            
    }

    [PunRPC]
    public void PassMainPlayerInfo1(string name) {
        playerName = PlayerPrefs.GetString("playerName");
        MultiplayerCombat.instance.player1Name = name;
        MultiplayerCombat.instance.textName1.text = name;
        //Invoke("SetUiNames1", 0.2f);
    }
    ...
    public void SetUiNames1() {
        if (pv.IsMine)
            MultiplayerCombat.instance.textName1.text = MultiplayerCombat.instance.player1Name;
    }
    ...
    public void TakeDamage() {
        ...
        currentLife -= MultiplayerCombat.instance.player1.GetComponent<MainPlayer>().playerDamage;
    ...
    public void RockAttack(int atk) {
        attack[atk] = 1;
        if (pv.IsMine)
            MultiplayerCombat.instance.Player1AttackSlot[atk].sprite = GameManager.instance.rock;
    }
    ...
    public void PaperAttack(int atk) {
        attack[atk] = 2;
        if (pv.IsMine)
            MultiplayerCombat.instance.Player1AttackSlot[atk].sprite = GameManager.instance.paper;
    }
    ...
    public void ScissorsAttack(int atk) {
        attack[atk] = 3;
        if (pv.IsMine)
            MultiplayerCombat.instance.Player1AttackSlot[atk].sprite = GameManager.instance.scissors;
    }
    ...
    public void CancelAttack(int atk) {
        if (MultiplayerCombat.instance.canCancelAttack) {
            attack[atk] = 0;
            MultiplayerCombat.instance.Player1AttackSlot[atk].sprite = GameManager.instance.mistery;
            ready = false;
        }
    }
    ...
    public void ResetAttack() {
        ...
        MultiplayerCombat.instance.Player1AttackSlot[0].sprite = GameManager.instance.mistery;
        MultiplayerCombat.instance.Player1AttackSlot[1].sprite = GameManager.instance.mistery;
        MultiplayerCombat.instance.Player1AttackSlot[2].sprite = GameManager.instance.mistery;
